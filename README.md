...
•	Contains an efficient algorithm to perform a smart guess based on feedback from the main thread, by generating a vicinity grid within which the next smart guess would be made.</br>


Requirements:
1. Android Studio
2. Java
3. Minimum SDK verison of API 21: Android 5.0 (Lollipop)</br></br></br>
